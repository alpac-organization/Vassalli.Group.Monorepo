...
export const TopNavbar = ({ isOpen, setIsOpen }: TopNavbarProps) => {
    ...
    <header className="h-16 dark:bg-[#272b34] border-b border-neutral-700 flex items-center justify-between px-4 sm:px-6 shrink-0 z-30 relative">
      ...
      <div className="relative">
        ...
        <div
          ...
          `}
        >
          <button className="w-full flex items-center gap-3 px-4 py-2 text-sm text-red-400 hover:bg-neutral-800 transition-colors">
            <LogOut size={16} />
            Logout
          </button>
        </div>
