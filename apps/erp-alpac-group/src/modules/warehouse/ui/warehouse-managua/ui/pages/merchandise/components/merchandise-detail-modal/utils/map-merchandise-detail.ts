...
export function mapMerchandiseDetailToDisplay(
  ...
  return {
    ...
    plateNumber: display(reception?.vehicle_plate_number),
    trailerChassis: display(reception?.vehicle_chassis_number),
    ...
    transportUnitName: display(reception?.transport_unit),
    sealNumber: display(reception?.seal_number),
    aduana: display(reception?.custom_branch),
    containerNumber: display(reception?.container_number),
    vehicleExitDate:formatDateToSpanishWords(reception?.vehicle_exit_date ?? "") ?? "",
    vehicleExitTime:formatTime(reception?.vehicle_exit_time ?? "") ?? "",
    containerExitDate:formatDateToSpanishWords(reception?.container_exit_date ?? "") ?? "",
    containerExitTime:formatTime(reception?.container_exit_time ?? "") ?? "",
    ...
    ducaName: display(duca?.sipping_company_name),
...
export function mapDucatToDisplay(
  ...
  return {
    ...
    productDescription: display(ducat.merchandise_description),
    remitente: display(ducat.sender),
