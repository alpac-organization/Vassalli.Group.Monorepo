...
export const SectionModal = ({ isOpen, warehouseId, onClose, onSubmit }: SectionModalProps) => {
	...
	const { CreateSection } = useWarehouseLayout();
								...
								{...register("overflow.max_overflow_polines", {
									validate: {
										validateInteger: (value) =>
											value === undefined || value === null || validateIntegerNumber(value),
										validatePositive: (value) =>
											value === undefined || value === null || validatePositiveNumber(value, true),
									},
									setValueAs: parseDecimal,
									onChange: (evt) => {
