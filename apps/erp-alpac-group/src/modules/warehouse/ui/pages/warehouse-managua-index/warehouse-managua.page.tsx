...
export const WarehouseManaguaPage = () => {
      ...
      >
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <StatsCard
               ...
               trend="Total de camiones dentro de la planta"
            ...
            <StatsCard
               title="PENDIENTE DE DESCARGUE"
               value={`0${formatNumber("8")}`}
               trend="Total de pendientes de descargas"
            ...
            <StatsCard
               title="DESPACHOS"
               value={`0${formatNumber("8")}`}
               trend="Total de despachos"
               icon={<HandPlatterIcon size={30} />}
               borderColor="border-orange-800! dark:border-purple-300!"
            />

            <StatsCard
               title="SALIDAS DE CAMIONES"
               value={formatNumber("20")}
               trend="Total de camiones que salieron del plantel"
