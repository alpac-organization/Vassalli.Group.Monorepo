import type { ControlModalVacationDetailsContentProps } from "@app/modules/payroll/ui/pages/control-vacations/components/control-vacations-details/type/control-vacation-details";
export function ControlModalVacationDetailsContent({
  details,
}: ControlModalVacationDetailsContentProps) {
  return (
