import type { AddDeductionCollaboratorSummaryProps } from "@app/modules/payroll/ui/pages/collaborator-index/components/add-deduction/types/collaborator-summary.type";

export function AddDeductionCollaboratorSummary({
  fullName,
  workPosition,
  isFullNameLoading = false,
  isWorkPositionLoading = false,
}: AddDeductionCollaboratorSummaryProps) {
  return (
    <div
