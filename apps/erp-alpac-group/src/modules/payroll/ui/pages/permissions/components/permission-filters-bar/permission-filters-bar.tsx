...
} from "@app/modules/payroll/ui/pages/permissions/constants/permission-filters.constants";
import type { PermissionFiltersBarProps } from "@app/modules/payroll/ui/pages/permissions/components/permission-filters-bar/types/PermissionFiltersBarProps";
import type {
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 items-end">
      ...
      <div className="flex flex-col">
        <Dropdown
          ...
          value={typeDraft}
          onChange={(v) => onTypeDraftChange(v as PermissionTypeFilterValue)}
