...
export class ManagementServices implements IManagementServices {
	...
	async GetRequisitionManagementReviews(payload: GetRequisitionManagementReviewsRequest): Promise<GetRequisitionManagementReviewsResponse> {
		...
		return this.apiService.get<GetRequisitionManagementReviewsResponse>(url, {
			params: cleanParams(rest),
		});
	}

	async GetRequisitionManagementReviewDetails(payload: GetRequisitionManagementReviewDetailRequest): Promise<RequisitionManagementReviewDetailsResponse> {
		...
		return this.apiService.get<RequisitionManagementReviewDetailsResponse>(url);
	}
