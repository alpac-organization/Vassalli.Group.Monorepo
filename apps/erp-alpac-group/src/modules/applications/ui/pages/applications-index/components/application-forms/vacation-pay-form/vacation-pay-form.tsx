...
import type { VacationPayFormProps } from "./vacation-pay-form.types";
import { VacationPayPanel } from "../../application-panels/vacation-pay-panel/vacation-pay-panel";

export const VacationPayForm = (props: VacationPayFormProps) => {
   ...
   return (
      <form className="flex flex-col gap-6">
         ...
         >
            ...
            <VacationPayPanel application={application} />
         ...
         {application.second_step_status.is_approved === null &&
