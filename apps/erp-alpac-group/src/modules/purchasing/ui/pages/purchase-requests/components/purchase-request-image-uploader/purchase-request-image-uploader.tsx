...
import type { PurchaseRequestImageUploaderProps } from "./purchase-request-image-uploader.types";
...
export function PurchaseRequestImageUploader({
	value,
	onChange,
	maxFiles = 3,
	error,
}: PurchaseRequestImageUploaderProps) {
