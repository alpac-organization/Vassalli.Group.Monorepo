...
export type PurchaseRequestStatusEnum =
  (typeof PurchaseRequestStatusEnum)[keyof typeof PurchaseRequestStatusEnum];

export const PurchaseRequestStatusOptions = Object.values(
  PurchaseRequestStatusEnum,
);
export type PurchaseRequestStatusType =
  (typeof PurchaseRequestStatusEnum)[keyof typeof PurchaseRequestStatusEnum]["textValue"];
