  ...
  return (
    <group position={[x, 0, z]}>
      ...
      <lineSegments position={[0, 0.065, 0]}>
        <edgesGeometry
          args={[new THREE.BoxGeometry(largo - 0.06, 0.01, ancho - 0.06)]}
        />
        <lineBasicMaterial color="#c0392b" />
      </lineSegments>
      <Text
        position={[0, 0.07, ancho * 0.15]}
  ...
  return (
    <div className="w-[100%] h-screen">
      ...
      >
        ...
        <OrbitControls target={[0, 2, 20]} maxPolarAngle={Math.PI / 2.05} />
      </Canvas>
    </div>
  );
};
