...
import { AcceptOfferModal } from "@app/modules/finance/ui/pages/quote-analisys/components/accept-offer-modal/accept-offer-modal";
...
const SendToReviewButton = ({
  ...
  setIsSendReviewOpen: React.Dispatch<React.SetStateAction<boolean>>;
...
export function QuoteAnalysisDetail() {
  ...
  const payloadGetQuoteAnalysisDetails = useMemo(
    () => ({
      ...
      purchase_requests_reviewed_accounting_id: reviewId || "",
    }),
          ...
          onError: (error) => {
            ...
            handleRequestError(
              errorMessage.description ??
                "Error al enviar la solicitud a revisión gerencial.",
            );
          },
        },
      );
  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-col gap-4 rounded-xl border border-slate-200 bg-white p-3 sm:gap-6 sm:p-5 md:p-6 dark:border-slate-700/50 dark:bg-[#272b34]">
        <div className="sticky -top-10 z-20 -mx-3 -mt-3 flex flex-col gap-3 border-b border-slate-200  bg-white px-3 pt-3 pb-4 sm:-mx-5 sm:-mt-5 sm:flex-row sm:items-start sm:justify-between sm:gap-4 sm:px-5 sm:pt-5 sm:pb-6 md:-mx-6 md:-mt-6 md:px-6 md:pt-6 dark:border-slate-700/50 dark:bg-[#272b34]">
          <div className="min-w-0">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-slate-600 sm:text-sm dark:text-slate-400">
              ...
              <span className="min-w-0 wrap-wrap-break-words">
        ...
        <div className="grid grid-cols-1 gap-4 md:gap-6 xl:grid-cols-2">
          <div className="flex min-w-0 flex-col gap-4 rounded-lg border border-slate-200 p-3 sm:p-5 dark:border-slate-700/50 dark:bg-[#1e2229]">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
              ...
              <div className="flex min-w-0 flex-col gap-1">
                ...
                <span className="wrap-wrap-break-words text-sm font-medium text-slate-900 dark:text-slate-200">
          ...
          <div className="flex min-w-0 flex-col gap-4 rounded-lg border border-slate-200 p-3 sm:p-5 dark:border-slate-700/50 dark:bg-[#1e2229]">
            ...
            {comments && (
              <div className="mt-auto wrap-break-words rounded-md bg-slate-50 p-3 text-sm text-slate-700 dark:bg-[#272b34] dark:text-slate-300">
                  ...
                  >
                    <div className="flex min-w-0 flex-col gap-3 p-3 sm:gap-4 sm:p-4">
                      {product.justification && (
                        <div className="wrap-break-words rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-700 sm:px-3.5 sm:py-3 dark:border-slate-700/50 dark:bg-[#272b34] dark:text-slate-300">
      ...
      <AcceptOfferModal
        ...
        isSubmitting={AcceptQuotationToPurchase.isPending}
