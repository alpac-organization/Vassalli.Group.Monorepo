...
import {
  getDatePickerSlotProps,
  mergeAlpacDatePickerSlotProps,
} from "./date-picker-slot-props";
...
export function DatePicker({
  ...
  const mergedSlotProps = mergeAlpacDatePickerSlotProps(
    getDatePickerSlotProps(fieldWidth),
    {
      ...slotProps,
      textField: {
        ...textFieldProps,
